...
class TestClient:
    ...
    @parametrize
    def test_method_health_check(self, client: Anyformat) -> None:
        client_ = client.health_check()
        assert_matches_type(object, client_, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_health_check(self, client: Anyformat) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_health_check(self, client: Anyformat) -> None:
...
class TestAsyncClient:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_health_check(self, async_client: AsyncAnyformat) -> None:
        client = await async_client.health_check()
        assert_matches_type(object, client, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_health_check(self, async_client: AsyncAnyformat) -> None:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_health_check(self, async_client: AsyncAnyformat) -> None:
