...
modify the contents of the `src/anyformat/lib/` and `examples/` directories.
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/stainless-sdks/anyformat-python/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
