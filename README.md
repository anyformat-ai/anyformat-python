...
pip install git+ssh://git@github.com/stainless-sdks/anyformat-python.git
```

> [!NOTE]
> Once this package is [published to PyPI](https://www.stainless.com/docs/guides/publish), this will become: `pip install anyformat`
...
```sh
# install from this staging repo
pip install 'anyformat[aiohttp] @ git+ssh://git@github.com/stainless-sdks/anyformat-python.git'
```
...
These methods return an [`APIResponse`](https://github.com/stainless-sdks/anyformat-python/tree/main/src/anyformat/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/stainless-sdks/anyformat-python/tree/main/src/anyformat/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/anyformat-python/issues) with questions, bugs, or suggestions.
